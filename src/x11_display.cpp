 ...
 * Author: 3urobeat
 *
 * Last Modified: 2025-04-20 11:19:00
...
void x11_take_screenshot(int width, int height, void (*screenshot_callback)(XImage *img, png_structp *png, png_infop *info))
{
    // Take screenshot
    XImage *img = XGetImage(display, root, 0, 0, width, height, AllPlanes, ZPixmap);

    screenshot_callback(img, nullptr, nullptr);
